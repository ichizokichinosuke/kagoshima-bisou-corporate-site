                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <br />
                              FAX
                              <span style={{ margin: '0 6.2em 0 0 ' }} />
                              099-204-9894
                              <br />
                              メールアドレス
                              <span style={{ margin: '0 1.25em 0 0 ' }} />
                              kk_bisou@lime.ocn.ne.jp
                            </td>
                          </tr>
                          <tr>
                            <th>設立</th>
                  ...
                  <table className="table is-hoverable has-text-lefted is-striped">
                    <tbody>
                      ...
                      <tr>
                        <th>平成30年9月</th>
                        <td>
                          がれき類、ガラスくず、コンクリートくず及び陶磁器くずの中間処理（破砕）追加
                        </td>
                      </tr>
                      <tr>
                        <th>平成31年2月</th>
                      ...
                      <tr>
                        <th>令和元年8月</th>
                        <td>
                          紙くず、木くず、繊維くず、ゴムくず、廃プラスチック類の中間処置（焼却）追加
                        </td>
                      </tr>
                      <tr>
                        <th>令和2年5月</th>
                      ...
                      <tr>
                        <th>令和3年3月</th>
                        <td>
                          金属くず（水銀使用産業廃棄物を含む）、ガラスくず、コンクリートくず
                          <br />
                          及び陶磁器くず（水銀使用産業廃棄物を含む）の中間処理（破砕）追加
                        </td>
                      </tr>
                      <tr>
                        <th>令和3年3月</th>
