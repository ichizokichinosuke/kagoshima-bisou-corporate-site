                ...
                <div className="content">
                    ...
                    <div className="columns">
                        ...
                        <div className="column">
                         <VehicleTable capacity="2" maxLoad="8800" totalHeavy="19920" length="770" width="290" height="376" displacement="8.86" />
                        </div>
                    </div>
                </div>
              </div>
              <div className="section">
                <div className="content">
                    ...
                    <div className="columns">
                        ...
                        <div className="column">
                         <VehicleTable capacity="2" maxLoad="1650" totalHeavy="7960" length="844" width="232" height="304" displacement="5.12" />
                        </div>
                    </div>
                </div>
              </div>
              <div className="section">
                <div className="content">
                    ...
                    <div className="columns">
                        ...
                        <div className="column">
                         <VehicleTable capacity="3" maxLoad="2000" totalHeavy="4605" length="469" width="169" height="195" displacement="4.89" />
                        </div>
                    </div>
                </div>
              </div>
              <div className="section">
                <div className="content">
                    ...
                    <div className="columns">
                        ...
                        <div className="column">
                         <VehicleTable capacity="3" maxLoad="3050" totalHeavy="7725" length="579" width="209" height="227" displacement="5.19" />
                        </div>
                    </div>
                </div>
              </div>
              <div className="section">
                <div className="content">
                    ...
                    <div className="columns">
                        ...
                        <div className="column">
                         <VehicleTable capacity="2" maxLoad="3500" totalHeavy="7960" length="620" width="219" height="240" displacement="5.12" />
                        </div>
                    </div>
                </div>
              </div>
